                        ...
                        <ul id="sponsors" class="tooltip-hover">
                            ...
                            <li data-toggle="tooltip" title="" data-original-title="Home Automation"> <a
                                    href="servicesbycategory/18.html"><img
                                        src="{{ asset('images/sercat/1521972593.png') }}" alt="Home Automation"></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="content_info">
            ...
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2>Fe-Kedmetak <span>Choice</span> of Services</h2>
                            ...
                            <ul class="services-lines">
                                    ...
                                    <a href="servicesbycategory/1.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969345.png') }}"></i>
                                            <h5>AC</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="servicesbycategory/3.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969409.png') }}"></i>
                                            <h5>Plumbing</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="servicesbycategory/4.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969419.png') }}"></i>
                                            <h5>Electrical</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="servicesbycategory/6.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969446.png') }}"></i>
                                            <h5>Home Cleaning</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="servicesbycategory/8.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969464.png') }}"></i>
                                            <h5>Pest Control</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="servicesbycategory/11.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969512.png') }}"></i>
                                ...
                                <li>
                                    <a href="servicesbycategory/12.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969522.png') }}"></i>
                                            <h5>TV</h5>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="servicesbycategory/13.html">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img"
                                                    src="{{ asset('images/sercat/1521969536.png') }}"></i>
                                            <h5>Refrigerator</h5>
                                        </div>
                                    </a>
                                </li>
...
{{--             
                <div>
                    <a class="g-list" href="service-details/carpet-shampooing.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/Carpet.jpg') }}" alt=""
                ...
                <div>
                    <a class="g-list" href="service-details/fabric-sofa-shampooing.html">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails/sofa.jpg') }}" alt=""
                                class="img-responsive">
                        </div>
